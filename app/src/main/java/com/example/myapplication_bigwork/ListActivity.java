    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item_id)
        {
            case R.id.item_home:
                ...
                /* 指定intent要启动的类 */
                intent_home.setClass(ListActivity.this, MainActivity.class);
                /* 启动一个新的Activity */
            ...
            case R.id.item_list:
                ...
                /* 指定intent要启动的类 */
                intent_list.setClass(ListActivity.this, ListActivity.class);
                /* 启动一个新的Activity */
            ...
            case R.id.item_statistic:
                ...
                /* 指定intent要启动的类 */
                intent_statistic.setClass(ListActivity.this, StatisticActivity.class);
                /* 启动一个新的Activity */
